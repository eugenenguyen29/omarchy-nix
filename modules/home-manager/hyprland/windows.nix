...
}:
{
  wayland.windowManager.hyprland.settings = {
    windowrule = [
      ...
      # suppress_event now needs a value and uses match: syntax
      ...
      # "nofocus on, match:class ^$, match:title ^$, match:xwayland 1, match:floating 1, match:fullscreen 0, match:pinned 0"
